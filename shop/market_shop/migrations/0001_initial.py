    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('basket_status', models.CharField(choices=[('chk', 'check'), ('del', 'delete'), ('vrf', 'verify'), ('act', 'active')], default='chk', max_length=3)),
                ('payment_price', models.IntegerField(blank=True, default=0)),
            ],
        ),
        migrations.CreateModel(
            name='BasketItem',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shop_status', models.CharField(choices=[('pub', 'publish'), ('del', 'delete'), ('not', 'notset'), ('act', 'active')], default='not', max_length=3)),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
