...
class PostForm(forms.ModelForm):
    ...
    class Meta :
        model = Post
        fields = ['title', 'description', 'bodytext', 'category', 'tag', 'image']
        widgets = {
...
class LoginForm(forms.Form):
    username = forms.CharField(widget=forms.TextInput(attrs={'placeholder': 'نام کاربر', 'class': 'form-control'}))
    password = forms.CharField(widget=forms.PasswordInput(attrs={'placeholder': 'رمز کاربر', 'class': 'form-control'}))
