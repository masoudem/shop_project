...
class SignUpForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['first_name', 'last_name', 'email',
                  'user_type_owner_shop', 'phone_number', 'password']
        widgets = {
...
class SignInForm(forms.Form):
    ...
    email_login = forms.CharField(widget=forms.EmailInput(
        attrs={'placeholder': 'نام کاربر', 'class': 'form_control'}))
    password = forms.CharField(widget=forms.PasswordInput(
        attrs={'placeholder': 'رمز کاربر', 'class': 'form_control'}))
